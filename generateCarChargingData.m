function generateCarChargingData
...
for ii=1:1:10   
   ...
   car.normalAlgorithmChargingPrice = priceComparisonVector(hijackedPriceIndex).normalPrice;
   ...
   ev_array = zeros(1440,1);
   ev_array(:,1) = 1:1:1440;
   
   ev_array( car.startChargingTimeHijacked : 1 : car.endChargingTimeHijacked , 2) = car.chargingPower;
   ...
   assignin('base',sprintf('house%d_ev_array',ii),ev_array);
